...
Anthony is quantitative sociologist and human geographer with advanced geospatial statistics training. Their overarching career aim reducing the open data and data science expertise barrier for researchers, policy makers, planning practitioners, and the public to co-design liveable cities where socially diverse communities can thrive.
