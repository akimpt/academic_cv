...
**Role**: Researcher (0.2FTE) focusing on Social Sustainability, Crime Prevention Through Environmental Design, identifying the barriers to active and public transport use, and accessing the social equity of land use and transport planning outcomes. 
...
**Role**: Lecturer currently teaching (0.7FTE) planning structures and statutory planning, regional planning, sustainable urban design and development, and planning theory. Notably nominated and awarded the UniSQ *Stella Award for Teaching* while having receiving a 6 course load during first 12 months of appointment and while maintaining a high research output rate.  
...
Primary supervisor for 3 PhD candidates, and associate supervisor for 3 further PhD candidates contributing specifically social science and geospatial analytics expertise
...
Supervised one PhD candidate to completion
...
<!-- Please Mind the Gap: Examining Regional Variations in Private Car Carbon Dioxide Emissions and Fuel Consumption The Case of Australia -->
`r x <- "Manual1"`
...
<!-- The temporality of on-street parking–exploring the role of la -->
`r x <- "Se3iqnhoufwC"`
